...
<body>
    ...
    <header class="vista">
        <div class="vista-top">
            ...
            <a href="login.php" class="btn btn-rounded">Iniciar sesión</a>
        </div>
        <div class="vista-content">
            ...
            <a href="peliculas.php" class="btn btn-xl">Acceder a Pelismedia<i
        ...
        <div class="container">
            ...
            <div id="tab-1-content" class="tab-content-item show">
                <div class="tab-1-content-inner">
                    <div>
                        ...
                        <a href="peliculas.php" class="btn btn-lg">Acceder a Pelismedia</a>
                    </div>
                    <img
            ...
            <div id="tab-3-content" class="tab-content-item">
                ...
                <div class="text-center">
                    <a href="login.php" class="btn btn-lg">INICIAR SESIÓN</a><p></p>
