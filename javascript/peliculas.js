    ...
    data.forEach(movie => {
        ...
        movieEl.innerHTML = `
            ...
            <div class="overview">
                ...
                ${overview}
                <br/> 
                <button class="ver-trailer" id="${id}">Ver Trailer</button
            </div>
...
/* Se cierra cuando pulsas en la equis del overlay */
function closeNav() {
...
form.addEventListener('submit', (e) => {
    ...
    setGenre();
    if(buscador) {
        getMovies(searchURL+'&query='+buscador)
    }else{
        getMovies(API_URL);
    }
